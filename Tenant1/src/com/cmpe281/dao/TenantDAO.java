...
public class TenantDAO {
	...
	public static Tenant save(Tenant tenant) {
		...
		String sql = "update UML_Parser_TenantA set SCALE=?,POINTS=?,COMPLETE=?, COMMENTS=? where ID=?";
		...
		try 
		{
			...
			prep.setString(3, tenant.getComplete());
			...
			prep1.setString(3, tenant.getComplete());
			prep1.setString(4, tenant.getComments());
			prep1.setString(5, "TA");
			prep1.executeUpdate();
			prep1.close();
