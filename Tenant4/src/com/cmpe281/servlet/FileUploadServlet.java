...
public class FileUploadServlet extends HttpServlet {
    ...
    private static final String IMAGE_DIRECTORY ="/usr/share/apache-tomcat-7.0.77/webapps/Tenant4/images/";
    @Override
    ...
    public static Process runJar(String name) {
    	...
    	try {
    		...
    		ProcessBuilder pb = new ProcessBuilder("java", "-jar", UPLOAD_DIRECTORY + "/"+"Parser.jar",UPLOAD_DIRECTORY + "/"+folderName, IMAGE_DIRECTORY+"image.png");
    		process = pb.start();	
