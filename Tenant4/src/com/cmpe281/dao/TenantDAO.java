...
public class TenantDAO {
	...
	public static Tenant save(Tenant tenant) {
		...
		String sql = "update UML_Parser_TenantD set DONE=?, BAND=?, COMMENTS=? where ID=?";
		...
		try 
		{
			...
			prep.setString(1, tenant.getDone());
			prep.setString(2, tenant.getBand());
			...
			prep1.setString(1, tenant.getDone());
			prep1.setString(2, tenant.getBand());
			prep1.setString(3, tenant.getComments());
			prep1.setString(4, "TD");
			prep1.executeUpdate();
			prep1.close();
