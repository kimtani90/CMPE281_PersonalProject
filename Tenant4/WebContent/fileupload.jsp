    ...
    <div class="content-wrapper py-3">
        ...
        <div class="container-fluid">
			...
			<c:if test="${imageDisplay eq true}">
			   ...
			   <img src="/Tenant4/images/image.png" style="width:550px;height:340px;" >
			</c:if>
		...
		<form action="SaveTenantDetailsServlet" method="get">	
            ...
            <div class="card mb-3">
				...
				<div class="form-group col-lg-4" >
					...
					<input type="text" name="fname" class="form-control" value="Dixita" readonly>
			
				</div>
				<div class="form-group col-lg-4">
					<label>Last Name</label>
					<input type="text" name="lname" class="form-control" id="" value="Patodiya" readonly>
